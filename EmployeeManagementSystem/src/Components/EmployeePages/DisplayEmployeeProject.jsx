    ...
    <div>
      ...
      >
        <Box display="flex" alignItems={"center"}>
          ...
          <Stack w="70%">
            <CardBody textAlign={"start"}>
              ...
              <Flex w={"90%"}>
                <VStack w={"30%"}>
                  <Text color={"blue.400"}> Project Status</Text>
                  <Badge p={"0.3rem 1.2rem 0.3rem 1.2rem"}bg={"green.200"} color={"black"}>{projectdata?.Status}</Badge>
                </VStack>
                <VStack w={"50%"}>
                  <Text fontWeight={"semibold"} color={"blue.400"}> Start Date</Text>
                 <Text color={"whiteAlpha.800"}>
                 {projectdata?.StartDate}
                  </Text>  
                </VStack>
                <VStack w={"50%"}>
                  <Text fontWeight={"semibold"} color={"blue.400"}>Estimated End Date</Text>
                  <Text color={"red.600"}>
                 {projectdata?.EndDate}
                  </Text>  
                </VStack>
        ...
        <Box alignItems={"center"} w={"90%"} m={"auto"}>
          <Text textAlign={"start"} fontWeight={"bold"} color={"blue.400"} >
            Project Description :{" "}
          </Text>
          <Text py="2" ml={"14"} textAlign={"start"} w={"90%"} color={"whiteAlpha.800"}>
